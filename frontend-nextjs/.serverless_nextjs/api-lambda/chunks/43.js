...
var _wrapNativeSuper2 = _interopRequireDefault(__webpack_require__(65957));
...
var _logger2 = _interopRequireWildcard(__webpack_require__(79498));

var _parseUrl = _interopRequireDefault(__webpack_require__(98341));
...
var _ampContext = __webpack_require__(22227);
var _headManagerContext = __webpack_require__(8404);
var _amp = __webpack_require__(13240);
function _interopRequireDefault(obj) {
    return obj && obj.__esModule ? obj : {
        default: obj
    };
...
function createLoadableComponent(loadFn, options) {
    ...
    // Client only
    if (!initialized && "undefined" !== 'undefined' && 0 && 0 && 0) {}
...
// Initialization
registerPostProcessor('Inline-Fonts', new FontOptimizerMiddleware(), // @ts-ignore
(options)=>options.optimizeFonts || true
);
registerPostProcessor('Preload Images', new ImageOptimizerMiddleware(), (options)=>options.optimizeImages || false
);
var _default = processHTML;
exports.Z = _default; //# sourceMappingURL=post-process.js.map
...
if (true) {
    ...
    postProcess = (__webpack_require__(47989)/* ["default"] */ .Z);
} else {}
function noRouter() {
    ...
    const renderDocument = async ()=>{
        ...
        if ( true && Document.getInitialProps) {
            ...
            const bodyResult = async ()=>{
                ...
                return concurrentFeatures ?  false ? 0 : await renderToNodeStream(content, generateStaticHTML) : piperFromArray([
